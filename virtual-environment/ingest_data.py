...
@click.option('--chunk_size', default=100000, type=int, help='Chunk size for data ingestion')
...
def run(pg_user, pg_password, pg_host, pg_port, pg_db, table_name, chunk_size, year, month):
